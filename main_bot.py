...
def home():
    ...
    <body style="font-family:sans-serif; padding:40px; background:#111; color:#eee;">
        ...
        <ul>
            ...
            <li><a href="/telegram-test" style="color:#4af">📨 Probar Telegram</a></li>
...
def telegram_test():
    """Prueba si el bot puede enviar mensajes por Telegram"""
    try:
        ok = telegram_send_message(ADMIN_CHAT_ID, "🧪 *TEST* El bot de AdivinoPicks esta funcionando correctamente.")
        if ok:
            return {"ok": True, "mensaje": "Mensaje de prueba enviado a tu Telegram. Revisa tu chat privado."}, 200
        else:
            return {"ok": False, "error": "Telegram respondio pero devolvio error. Verifica que el ADMIN_CHAT_ID sea correcto y que hayas iniciado conversacion con el bot."}, 200
